...
- [D<sup>3</sup>E](http://www.sanger.ac.uk/sanger/GeneRegulation_D3E/) - [online]((http://www.sanger.ac.uk/sanger/GeneRegulation_D3E/)) - Discrete Distributional Differential Expression (D<sub>3</sub>E) is a tool for identifying differentially-expressed genes, based on single-cell RNA-seq data.
